...
log_file_path = "D:\Advanced Python Project\like.log"
...
def display_first_chart():
    chart_data = pd.read_csv(log_file_path, header=None)  # Read CSV file without headers
...
def file_like_chart(username):
    ...
    chart_data = pd.read_csv(log_file_path, header=None)  # Skip headers by setting header=None
